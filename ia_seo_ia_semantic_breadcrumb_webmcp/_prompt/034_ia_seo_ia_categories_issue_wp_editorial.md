...
# INSERT
Atelier des Médias | atelier des médias | atelier des medias | Atelier des Medias

émission de RFI consacrée aux mutations du monde des médias et de la société numérique. 
RFI's program dedicated to the changes in the world of media and digital society.

# INSERT

A Navalla Suíza | A navalla suiza | a navalla suiza | A Navalla Suiza
Q12382300
https://www.wikidata.org/wiki/Q12382300

empresa galega adicada ó deseño de proxectos web. Fundouse no ano 2008, tiña a súa sede no Milladoiro e pertencía a Eganet

galician company dedicated to the design of web projects. It was founded in 2008, had its headquarters in O Milladoiro and belonged to Eganet

entreprise galicienne spécialisée dans la conception de projets web. Fondée en 2008, elle avait son siège social à O Milladoiro et appartenait au groupe Eganet.
 
# INSERT

LinkBee
- online reputation management (Q1975845)

online reputation management (ORM) est l’influence et le contrôle de la réputation des organisations sur Internet

online reputation management (ORM) is the influence and control of an organization's reputation on the Internet.
...
# INSERT
- Adobe Wallaby (Q4684014)
digital file converter application for converting Flash source files (.FLA) into sets of HTML5, SVG, CSS, image and JavaScript files that can function without the presence of Adobe Player

application de conversion de fichiers numériques pour convertir les fichiers sources Flash (.FLA) en ensembles de fichiers HTML5, SVG, CSS, image et JavaScript qui peuvent fonctionner sans la présence d'Adobe Player

# INSERT

- What's Up films (Q64596855)

independent audiovisual production company. Since 2008, it has produced documentaries and fiction films in very different genres.

société de production audiovisuelle indépendante. Depuis 2008, elle produit des documentaires, des fictions, dans des genres très différents.

# INSERT

- Bada
bada
Android, Blackberry, Windows Phone, Palm WebOS, Bada et Symbian.
Bada (operating system)

# EN
discontinued mobile operating system developed by Samsung Electronics for devices such as mid- to high-end smartphones and tablet computers

# FR
système d'exploitation mobile abandonné, développé par Samsung Electronics pour des appareils tels que les smartphones et tablettes de milieu et haut de gamme.
...
# EN
JavaScript HTTP client that provides a simple and easy-to-use API for making HTTP requests. It supports all modern browsers and is widely used in the JavaScript community. Here are some of the features that make axios a great choice for your next project.

# FR
bibliothèque logicielle JavaScript offrant une API simple et facile à utiliser pour effectuer des requêtes HTTP
...
# EN
born in 1952, he is a producer and screenwriter. He is known for Ma'abarot (2019), HaDocomentaristim (2016) and HaGashash - The Tip of the Kettle (2023)

# FR
né en 1952. Il est producteur et scénariste. Il est connu pour Ma'abarot (2019), HaDocomentaristim (2016) et HaGashash - The Tip of the Kettle (2023)
