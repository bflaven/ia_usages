...
# 075_strategy_IA_fmm.md



As a python expert, can you rewrite the script below without changes expect that externalize the following variables like OLLAMA_URL, MODEL_NAME, cms_section_keywords_list, lang, content, prompt_template, STREAM, OUTPUT_FILE in a python file named config.py, the file will be at the same level as the script named : 001a_ner_F24_FR_Focus_MZ508039.py

It will help me to update the values into the file config.py to launch the script easily with new values.
