...
if st.button("💾 Update config.py"):
    try:
        # Step 1: Backup current config.py
...
st.info("After updating, you can run query_ollama.py with your new settings. The previous config is automatically backed up.")
