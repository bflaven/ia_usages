...
[env]
# Conda Environment
conda create --name yolo_service python=3.9.13
conda info --envs
source activate yolo_service
conda deactivate

# if needed to remove
conda env remove -n [NAME_OF_THE_CONDA_ENVIRONMENT]
conda env remove -n yolo_service
...
# [path]
cd /Users/brunoflaven/Documents/03_git/ia_usages/ai_fastapi_yolo_custom_object_detector_custom_dataset/001_yolov8_fastapi/
