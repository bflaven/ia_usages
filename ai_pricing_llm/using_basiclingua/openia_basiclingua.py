...
class OpenAILingua:
    ...
    def text_replace(self, user_input: str, replacement_rules: str) -> str:
        ...
        try:
            ...
            result = [(line.split(":")[0], line.split(":")[1])
                      for line in response if line.strip()]
    ...
    def text_spellcheck(self, user_input: str) -> str:
        ...
        try:
            ...
            result = [(line.split(":")[0], line.split(":")[1])
                      for line in response1 if line.strip()]
    ...
    def text_srl(self, user_input: str) -> dict:
        ...
        try:
            ...
            result = {key.replace("- ", ""): value for key,
   ...
   ############## TEXT IDIOMS ##############
    ...
    def text_coreference(self, user_input: str) -> dict:
        ...
        Pronoun: Referent
        ...
        output must not contain another information.
        '''
        ...
        try:
            ...
            coreferences = [
                coreference for coreference in coreferences if coreference]
            coreferences_dict = {item.split(': ')[0]: item.split(': ')[
                1] for item in coreferences}
   ...
   ############## PDF CHAT ##############
    ...
    def chat_pdf(self, user_input: str, pdf_path: str, pages: str = "all") -> str:
        ...
        if pages != "all":
            ...
            if "-" not in pages:
                raise ValueError(
                    "Please provide pages in the format 'integer-integer'")
            pages = pages.split("-")
            pdf_text = ''
        ...
        try:
            ...
            raise ValueError(
                "Please provide a correct PdF path/API Key or try again.")
