...
python 013_ia_using_claude_agents_sdk.py --keyword "Eco-Friendly Products" --context "Write a blog about sustainable alternatives to single-use plastics"

python 013_ia_using_claude_agents_sdk.py --keyword "MCP, AI models, different data sources and tools" --context "Write a blog about MCP that is an open protocol that standardizes how applications provide context to LLMs."
...
class ClaudeBlogCreator:
    ...
    def create_blog_post(self, keyword: str, context: str, max_tokens: int = 4000) -> str:
        """
...
def run_blog_creator(keyword: str, context: str, model: str = None, 
    ...
    blog_post = blog_creator.create_blog_post(
        keyword=keyword,
        context=context,
        max_tokens=max_tokens
    )
