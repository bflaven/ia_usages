...
- **Default mode (checkbox unchecked):** All posts from CSV/database shown. Drag to reorder.
- **Custom selection (checkbox checked):** Click to select/deselect (green = selected). Drag to reorder.
- **Reset button:** Complete reset. Unchecks custom selection and restores original CSV/database list.
