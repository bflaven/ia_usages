...
The code below is working reindent the code and make proprer comment.
            ...
            <div class="semaphore-dashboard-main">
                ...
                <div class="semaphore-side-card">
                    ...
                    <ul class="semaphore-side-links">
                        <li><strong>Semaphore: Related Embeddings</strong> – uses post/post similarities to build “Related Posts IA”.</li>
                        <li><strong>Semaphore: Tag Families CSV</strong> – imports/export families to keep semantic clusters in sync with your NLP pipeline.</li>
                    </ul>
                </div>
...
It does not work at all... no 3-2 columns no more green on selected tags or families tags, I have to rollback to that version below (Version: 1.2.0). Can you write a complete new Version: 1.2.1 and so I cut and paste. I have created the tree of the plugin like can you take it into account for this new version Version: 1.2.1 
    ...
    <div class="semantic-sidebar-widget">
        ...
        ?>
            <div class="related-posts-section">
                <h3>Related Posts IA (sidebar)</h3>
                <ul>
        ...
        <?php elseif ( get_option( 'semaphore_debug' ) ) : ?>
            <div class="bf-info-box">
                <strong>Related Posts (sidebar)bread</strong>
...
function semaphore_render_footer_related() {
    ...
    $related_posts = function_exists( 'semaphore_get_related_posts' ) ? semaphore_get_related_posts( $post->ID, 3 ) : array();
    if ( ! empty( $related_posts ) ) {
        $html .= '<h3>Related Posts IA (footer)</h3>';
        $html .= '<div class="related-posts-grid">';
    ...
    if ( $tags ) {
        ...
        if ( $family_entry_tag ) {
            ...
            if ( ! empty( $related_tags ) && is_array( $related_tags ) ) {
                $html .= '<div class="related-tags-section">';
                $html .= '<h4>Explore Related Tags IA (footer)</h4>';
                $html .= '<div class="tag-cloud">';
