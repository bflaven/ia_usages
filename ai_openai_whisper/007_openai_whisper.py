...
# be sure to rename the file in the directory ot simplify the name
result = model.transcribe("video_download_from_yt/sample_yt.mp4", fp16=False)
# show result
# print(result["text"])
