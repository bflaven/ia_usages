...
# LAUNCH the file
python 022_ollama_text_classification.py
...
FULL_CSV_SOURCE='_06_published_posts_table_france24_01-07-2023_31-12-2023.csv'
...
for index, row in df.iterrows():
    ...
    llm = Ollama(temperature=0.7, model=llm_model)
    ...
    first_prompt = ChatPromptTemplate.from_template(
        "Act as a highly intelligent news chatbot and classify the given news text into one of the following categories only 1. France 2. Europe 3. Africa 4. Americas 5. Asia-Pacific 6. Middle East 7. Sports 8. Economy 9. Technology 10. Culture 11. Environment. Do not code. Return only one word answer with only the category name that the given news text belongs to.\t News text: {news}?"
    ) 
