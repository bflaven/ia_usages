...
###### EXTRACT FROM 001_prompts_seo_bestof.md ######

### 1. Conduct Keyword Research
prompt_template = f'''
As an {user_input_language} SEO expert, can you help me identify high-volume and low-competition keywords for a post about '{user_input}'? Please provide a list of 10 keywords along with their search volume and competition level in {user_input_language}?
'''
...
# """
# user_keywords_list = """
# SEO, social media marketing, content marketing, email marketing, PPC advertising
# """

# prompt_template = f'''
# As an {user_input_language} SEO expert, I have a list of keywords related to '{user_input}'. Can you group these keywords into categories based on their semantic relevance? Here is the list: {user_keywords_list}.
# '''

### 3. Create Topic Clusters
# prompt_template = f'''
# As an {user_input_language} SEO expert, I want to create topic clusters for my site about '{user_input}'. Can you suggest main topics and subtopics that would form effective content clusters?
# '''

### 4. Generate Headline Ideas
# prompt_template = f'''
# As an {user_input_language} SEO expert, can you generate 10 compelling headline ideas for a post about '{user_input}'?
# '''

### 5. Craft Content Outlines
# Can be replaced by '{user_input}'
# prompt_template = f'''
# As an {user_input_language} SEO expert, I need an outline for a blog post titled 'The Ultimate Guide to Remote Work'. Can you provide a detailed outline including introduction, main points, and conclusion?
# '''

### 6. Create Content
# prompt_template = f'''
# As an {user_input_language} SEO expert, can you write a 500-word post about '{user_input}'? Please make it engaging and SEO-friendly.
# '''

### 7. Identify Websites for Guest Post Outreach
# prompt_template = f'''
# As an {user_input_language} SEO expert, can you help me identify 10 high-authority websites where I can submit a guest post about '{user_input}'? Please include their domain authority and contact information if available.
# '''

### 8. Generate Structured Data
# prompt_template = f'''
# As an {user_input_language} SEO expert, can you generate structured data (schema markup) for an article about '{user_input}'? Please provide the JSON-LD format.
# '''
...
# """
# prompt_template = f'''
# As an {user_input_language} SEO expert, I need meta descriptions for my website pages about '{user_input}'. Can you generate unique meta descriptions for each of these pages: {user_keywords_list}?
# '''

### 10. Write Meta Tags
# prompt_template = f'''
# As an {user_input_language} SEO expert, can you help me write meta tags for a webpage about '{user_input}'? Please include title tags and meta descriptions.
# '''

### 11. Create Crawl Directives for Robots.txt
# prompt_template = f'''
# As a SEO expert, I need to create a robots.txt file for my website. Can you generate directives to allow all search engines to crawl the site but disallow them from indexing the 'private' directory?
# '''

### 12. Create Regular Expression (Regex) Patterns
# prompt_template = f'''
# As a SEO expert, can you provide a regex pattern to match all email addresses in a text? Also, explain how this pattern works.
# '''

### 13. Generate Sitemaps
# prompt_template = f'''
# As a SEO expert, can you help me generate an XML sitemap for a website with the following URLs: /home, /about, /services, /blog, /contact? Please include the priority and change frequency for each URL.
# '''


###### EXTRACT FROM 002_prompts_seo_bestof.md ######
