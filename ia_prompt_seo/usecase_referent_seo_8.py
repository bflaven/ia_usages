...
# launch the file
python usecase_referent_seo_9.py
...
def openai_chat(prompt_key, user_input):
    ...
    user_prompt = seo_prompts[prompt_key].format(user_input=user_input)
...
As a SEO expert, I want to create topic clusters for my post about '{user_input}'. Can you suggest main topics and subtopics, in the same language as the post, that would form effective content clusters ?
 """,
...
As a SEO expert, I need an outline for a post titled '{user_input}' in the same language as the post. Can you provide a detailed outline including introduction, main points, and conclusion in the same language as the post?
""",
...
# prompt_key = "seo_other_conduct_keyword_research"
# Example
# user_input_special = "healthy eating habits"

# IRL
# user_input_special = "Brasil: deforestación en el Cerrado supera por primera vez la de Amazonía"


### 2. Group Keywords Based on Semantic Relevance

# prompt_key = "seo_other_group_keywords_semantic_relevance"

# Example
# user_input_special = "digital marketing"
# You can add your own list "SEO, social media marketing, content marketing, email marketing, PPC advertising."
# IRL
# user_input_special = user_input

### 3. Create Topic Clusters
# prompt_key = "seo_other_create_topic_clusters"

# Example
# user_input_special = "personal finance"
...
### 4. Generate Headline Ideas
# prompt_key = "seo_other_generate_headline_ideas"

# Example
# user_input_special = "the benefits of yoga for mental health"
...
### 5. Craft Content Outlines
# prompt_key = "seo_other_craft_content_outlines"

# Example
# user_input_special = "The Ultimate Guide to Remote Work"
...
### 6. Create Content
# prompt_key = "seo_other_create_content"

# Example
# user_input_special = "how to create a morning routine that boosts productivity"
...
### 7. Identify Websites for Guest Post Outreach
# prompt_key = "seo_other_identify_websites_guest_post_outreach"

# Example
# user_input_special = "sustainable living"
...
### 8. Generate Structured Data
# prompt_key = "seo_other_generate_structured_data"

# Example
# user_input_special = "the best vegan recipes"

# IRL (USELESS)
# user_input_special = user_input

### 9. Automate Meta Description Writing
# prompt_key = "seo_other_automate_meta_description_writing"

# Example
# user_input_special = "digital marketing services"
...
### 10. Write Meta Tags
# prompt_key = "seo_other_write_meta_tags"

# Example
# user_input_special = "eco-friendly home improvements"

# IRL
# user_input_special = user_input

### 11. Create Crawl Directives for Robots.txt
# prompt_key = "seo_other_create_crawl_directives_robots"

# Example
# user_input_special = "private"
...
### 12. Create Regular Expression (Regex) Patterns
# prompt_key = "seo_other_create_regex_patterns"

# Example
# user_input_special = "email addresses"

# IRL (USELESS)
# user_input_special = user_input

### 13. Generate Sitemaps
# prompt_key = "seo_other_generate_sitemaps"

# Example
# user_input_special = "/home, /about, /services, /blog, /contact"

# IRL (USELESS)
# user_input_special = user_input

# Calling the function with the prompt key and user input
response = openai_chat(prompt_key, user_input_special)
