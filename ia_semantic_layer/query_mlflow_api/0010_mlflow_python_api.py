...
# LAUNCH the file
python 0010_mlflow_python_api.py
...
def main():
    ...
    # ============================================================================
    # CONFIGURATION - Load from .env file and external prompt template
    # ============================================================================
    ...
    GATEWAY_ENDPOINT_NAME = os.getenv('GATEWAY_ENDPOINT_NAME')
    ...
    try:
        ...
        logger.info(f"Loaded prompt template from {PROMPT_TEMPLATE_FILE}")
    except FileNotFoundError:
