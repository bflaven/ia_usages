...
# LAUNCH the file
python 0007_mlflow_python_api.py
...
def main():
    ...
    PROMPT_TEMPLATE = "Summarize in {{ lang }} the given text \"{{ text }}\" in {{ lang }} into a concise and coherent summary, capturing the main ideas and key points. Make sure that the summary does not exceed {{ word_count }} words."
